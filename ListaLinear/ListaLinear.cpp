...
int numeroExcluir;
	cout << "Digite o numero do elemento que deseja excluir" << endl;
	cin >> numeroExcluir;
	int posicao = posicaoElemento(numeroExcluir);

	if (posicao == -1 && nElementos < 0) {
		cout << "O elemento nao pode ser excluido pois nao existe" << endl;
		return;
	}
